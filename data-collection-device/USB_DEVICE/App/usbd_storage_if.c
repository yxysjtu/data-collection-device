...
{
  /* USER CODE BEGIN 6 */
	//STMFLASH_Read(FLASH_SAVE_ADDR+blk_addr*STORAGE_BLK_SIZ,(u16*)buf,blk_len*STORAGE_BLK_SIZ);
  //return (USBD_OK);
	if(lun == 0)
	{
...
{
  /* USER CODE BEGIN 7 */
	//STMFLASH_Write(FLASH_SAVE_ADDR+blk_addr*STORAGE_BLK_SIZ,(u16*)buf,blk_len*STORAGE_BLK_SIZ);
  //return (USBD_OK);
	uint16_t i;
